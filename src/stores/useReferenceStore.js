...
export const useReferenceStore = defineStore('reference', () => {
    ...
    function getLocalDiseases() {
        return [
            ...
            //     id: '4',
            //     name: 'Фузариоз',
            //     description: 'Грибковое заболевание сосудистой системы растения. Грибок проникает через корни и закупоривает сосуды.',
            //     symptoms: ['Побурение сосудов', 'Пожелтение листьев', 'Листья вянут', 'Увядание'],
            //     treatment: 'Пересадка в стерильную почву, обработка фунгицидом (Фундазол)',
            //     prevention: 'Стерилизация почвы, правильный полив, хороший дренаж',
